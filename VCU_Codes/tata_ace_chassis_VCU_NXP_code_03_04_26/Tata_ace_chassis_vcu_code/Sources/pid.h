...
#include "osif.h" // NXP's OSIF for millisecond time
#define GetTime() OSIF_GetMilliseconds()
/* ------------------------------------------------------------------ */
...
//#include <string.h>
//
//// Include your platform's system timer
//#include "osif.h" // NXP's OSIF for millisecond time
//#define GetTime() OSIF_GetMilliseconds()
//
///* ------------------------ Library ------------------------ */
...
//         double Kp, double Ki, double Kd, PIDPON_TypeDef POn, PIDCD_TypeDef ControllerDirection);
