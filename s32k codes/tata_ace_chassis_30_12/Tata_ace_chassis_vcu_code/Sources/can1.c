  ...
  //	while(FLEXCAN_DRV_Init(INST_CANCOM1, &canCom1_State, &canCom1_InitConfig0)&&FLEXCAN_DRV_ConfigTxMb(INST_CANCOM1,2U,&can1_data_init,0x0)&&FLEXCAN_DRV_ConfigRxMb(INST_CANCOM1,5U,&can1_data_init,0x0)){
  	 while(can1.init_check || can1.conf_tx_check || can1.conf_rx_check || can1.conf_rx_check_std || can1.conf_tx_check_std){
  		...
  		//	FLEXCAN_DRV_SetRxIndividualMask(INST_CANCOM1,3U, FLEXCAN_MSG_ID_EXT, 0x1FFFFFFF);
  			  can1.conf_rx_check = FLEXCAN_DRV_ConfigRxMb(INST_CANCOM1,3U,&can1_data_init, from_pdu);
        ...
        FLEXCAN_DRV_SetRxIndividualMask(INST_CANCOM1,FLEXCAN_MSG_ID_EXT,3U,  0x1FFFFFFF);

        FLEXCAN_DRV_ConfigRxMb(INST_CANCOM1,4U,&can1_data_init, from_bms);
        FLEXCAN_DRV_SetRxIndividualMask(INST_CANCOM1,FLEXCAN_MSG_ID_EXT,4U, 0x1FFFFFFF);

        FLEXCAN_DRV_ConfigRxMb(INST_CANCOM1,5U,&can1_data_init, from_mcu);
        FLEXCAN_DRV_SetRxIndividualMask(INST_CANCOM1,FLEXCAN_MSG_ID_EXT,5U, 0x1FFFFFFF);

        FLEXCAN_DRV_ConfigRxMb(INST_CANCOM1,6U,&can1_data_init, from_steering);
        FLEXCAN_DRV_SetRxIndividualMask(INST_CANCOM1,FLEXCAN_MSG_ID_EXT,6U, 0x1FFFFFFF);//from_radar


		 FLEXCAN_DRV_ConfigRxMb(INST_CANCOM1,7U,&can1_data_init, from_rfid);
		 FLEXCAN_DRV_SetRxIndividualMask(INST_CANCOM1,FLEXCAN_MSG_ID_EXT,7U, 0x1FFFFFFF);//from_radar


  ///	FLEXCAN_DRV_ConfigRxMb(INST_CANCOM1, 3U, &can1_data_init, 0x1821FFD9);

  	//	FLEXCAN_DRV_SetRxIndividualMask(INST_CANCOM1, 4U, FLEXCAN_MSG_ID_EXT, 0x1FFFFFFF);
